...
const ActionCard = () => {
  const openWebsite = (websiteLink: string) => {
    Linking.openURL(websiteLink).then(() => {
      console.log('opened');
    });
  };
  return (
